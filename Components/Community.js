        ...
        <View style={styles.container}>
            <View style={styles.discoverStyle}>
                ...
                <View style={{flex:1,flexDirection:"row",marginLeft:30}}>
                    ...
                    <TouchableOpacity style={{flex:1,marginLeft:0}} onPress={()=>{navigation.navigate('DailyHelp')}}>
                        <MaterialCommunityIcons  name="van-utility" size={40} color="#434F39" />
                    </TouchableOpacity>
                </View>
                
                <View style={{flex :1,flexDirection:"row",marginLeft:0,}}>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginLeft:22}}>Resident</Text>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginRight:10}}>Emergency NO.s</Text>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginLeft:18}}>Daily Help</Text>                      
                </View>
            </View>
            ...
            <View style={styles.PaymentStyle}>
                ...
                <View style={{flex:1,flexDirection:"row",marginLeft:30}}>
                    ...
                    <MaterialCommunityIcons name="radio-tower" size={40} color="black" />
                    </TouchableOpacity>
                    
                </View>
                
                <View style={{flex :1,flexDirection:"row",marginLeft:0,}}>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginLeft:35}}>Rent</Text>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginRight:150,marginLeft:30}}>Utility Payment</Text>            
                </View>
            </View>
            ...
            <View style={styles.EngageStyle}>
                ...
                <View style={{flex :1,flexDirection:"row",marginLeft:0,}}>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginLeft:35}}>Help Desk</Text>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginLeft:10}}>Amenities</Text>
                    <Text style={{flex:1,fontWeight:'400',fontSize:12,lineHeight:14,marginRight:20}}>Communications</Text>
                </View>
