...
useEffect(()=>{
    ...
    return(
      ...
      //numColumns={1}
                ...
                <View>
                    <TouchableOpacity style={{flexDirection:"row",justifyContent:"space-between"}} onPress={()=>{navigation.navigate('DailyHelpDetail',{
                      name:item.name,
                    ...
                    <View style={{borderWidth:0.5,borderColor:'#D9D9D9',width:380,marginLeft:-15}}></View>
